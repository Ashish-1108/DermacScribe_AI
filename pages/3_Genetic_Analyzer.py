...
def load_css():
    ...
    <style>
        ...
        /* Targets the main containers on Home, Questionnaire, Report */
         .card-container { /* <-- THIS WAS THE FIX: Changed .stContainer to .card-container */
        ...
        [data-testid="stExpander"] [data-testid="stExpanderDetails"] { /* Expander content area */
         ...
         /* Override for expanders inside questionnaire container (This is likely dead code as structure changed, but harmless) */
        ...
        .stExpander ul li { /* Contributing factors list */
         ...
         /* Fix for expander content background override (Harmless dead code) */
         .stContainer [data-testid="stExpander"] [data-testid="stExpanderDetails"] {
...
def main():
    ...
    <div class="title-container">
        <div class="title-main">Genetic Risk Analyzer</div>
    </div>
    """, unsafe_allow_html=True)
