...
def main():
    ...
    <div style="text-align:center; margin-top:0.5rem; margin-bottom:1.25rem;">
        ...
        <div style="font-family: var(--font-heading); color:#4A3F5E; font-weight:700; letter-spacing:1px; font-size:clamp(2.0rem, 6.1vw, 3.2rem); margin-top:0.3rem; text-shadow: 0 8px 30px rgba(74,63,94,0.08);">Sun-Safe</div>
