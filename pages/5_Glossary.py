...
# --- This path points to the "glossary.png" file in the same directory as the script --- # <-- CHANGED
# Make sure 'glossary.png' is in the same folder as this .py file! # <-- CHANGED
script_dir = os.path.dirname(__file__) # <-- CHANGED
image_path = os.path.join(script_dir, "glossary.png") # <-- CHANGED
...
def run_glossary_app():
    ...
    if hero_image:
        ...
        with img_col:
            st.image(hero_image, use_container_width=True, caption="Ingredient Glossary") # <-- CHANGED CAPTION
